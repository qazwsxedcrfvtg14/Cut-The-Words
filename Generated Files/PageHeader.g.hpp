...
void ::CutTheWords::Controls::PageHeader::InitializeComponent()
{
    if (_contentLoaded)
    {
        return;
...
/// </summary>
class CutTheWords::Controls::PageHeader::PageHeader_obj1_Bindings 
    : public ::XamlBindingInfo::XamlBindingsBase<::CutTheWords::Controls::PageHeader>
{
public:
...
private:
    ...
    void Update_(::CutTheWords::Controls::PageHeader^ obj, int phase)
    {
        if (obj != nullptr)
        {
...
void ::CutTheWords::Controls::PageHeader::Connect(int __connectionId, ::Platform::Object^ __target)
{
    switch (__connectionId)
    {
        case 2:
...
::Windows::UI::Xaml::Markup::IComponentConnector^ ::CutTheWords::Controls::PageHeader::GetBindingConnector(int __connectionId, ::Platform::Object^ __target)
{
